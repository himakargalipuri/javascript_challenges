...
if ( (amt % 100 == 0) && (amt < sum) ) {
    for (var i = amt; i > 0;) {
        ...
        // else{
        //     console.log("Requested amount cannot be dispensed, Amount not Available.");
        // }
    }
